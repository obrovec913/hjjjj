    ...
    $.fn.aws_search = function( options ) {
        ...
        var methods = {
            ...
            showResults: function( response ) {
                    ...
                    $.each(response.products, function (i, result) {
                        ...
                        if ( result.add_to_cart ) {
                            ...
                            if ( result.add_to_cart.quantity && result.add_to_cart.permalink.indexOf('add-to-cart') !== -1 ) {
                                html += '<input type="number" data-quantity class="aws_quantity_field" step="1" min="1" max="' + result.add_to_cart.quantity_max + '" name="quantity" value="1" title="Quantity" size="4">';
                            }
                ...
                if ( ! d.smoothScroll && ! methods.isMobile() ) {
